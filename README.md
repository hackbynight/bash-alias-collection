...
alias nmapz='/home/hackbynight/scripts/gen_nmap.py; while read item; do sudo nmap -sV -sC -sU -sS $item; done < nmap.txt; rm mscan.txt nmap.txt'
...
alias wes-ng='python /home/hackbynight/scripts/windows/wesng/wes.py'
alias aslr_off='echo 0 | sudo tee /proc/sys/kernel/randomize_va_space'
alias gen_nmap='/home/hackbynight/scripts/gen_nmap.py'
...
alias android_studio='/home/hackbynight/apps/android-studio/bin/studio.sh'
alias rustscan='docker run -it --rm --name rustscan rustscan/rustscan:1.10.0'
alias pipz_upgrade='pip freeze > requirements.txt; pip install -r requirements.txt --upgrade; rm requirements.txt;'
alias ghidra_auto='python3 /home/hackbynight/apps/auto_ghidra.py'
alias pwninit='/home/hackbynight/apps/pwninit --template-path ~/.config/pwninit-template.py; sed -n "4,6p" solve.py; rm solve.py; mv *_patched $1'
...
alias enum4linux='python /home/hackbynight/scripts/enum4linux-ng/enum4linux-ng.py'
alias subbrute='python /home/hackbynight/apps/subbrute/subbrute.py'
alias mobsf_emulator='emulator -avd $1 -writable-system -no-snapshot'
alias codemerx='/home/hackbynight/apps/codemerx/bin/CodemerxDecompile'
alias webdavup='sudo wsgidav --host=$1 --port=$2 --root=/tmp --auth=anonymous'
alias username-anarchy='ruby /home/hackbynight/apps/username-anarchy/username-anarchy'
alias xs-strike='python /home/hackbynight/apps/XSStrike/xsstrike.py'
alias jwt_tool='python /home/hackbynight/apps/jwt_tool/jwt_tool.py'
